...
departments.post("/departments/create", async (req, res) => {
  try {
    ...
    const newDepartment = await Departmentsmodel({ name, description });
...
departments.patch("/departments/update/:departmentId", async (req, res) => {
  try {
    const { departmentId } = req.params;
